package qwq.wumie.systems.viaversion.provider;
...
import qwq.wumie.systems.viaversion.platform.FabricViaAPI;
import qwq.wumie.systems.viaversion.platform.FabricViaConfig;
import qwq.wumie.systems.viaversion.platform.NativeVersionProvider;
...
public abstract class AbstractFabricPlatform implements ViaPlatform<UUID> {
	...
	public void init() {
		...
		Path configDir = FabricLoader.getInstance().getConfigDir().resolve("viaversion");
	...
	public String getPlatformVersion() {
		return FabricLoader.getInstance().getModContainer("viaversion")
