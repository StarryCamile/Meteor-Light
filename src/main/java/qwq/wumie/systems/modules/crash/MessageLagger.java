...
public class MessageLagger extends Module {
    ...
    public MessageLagger() {
        super(Categories.Crash, "message-lagger", "Sends dense messages that lag other players on the server.");
    }
    ...
    private void sendLagWhisper() {
        ...
        sendChatMessage("/msg " + player.getGameProfile().getName() + " " + message);
    }
