...
import qwq.wumie.systems.modules.lemon.utils.NewRenderUtils;
...
public class NewSurround extends Module {
    ...
    public NewSurround() {
        super(Categories.Combat, "lemon-surround", "Surrounds you in blocks to prevent crystal damage");
    }
    ...
    private class RenderBlock {
        ...
        public void render(Render3DEvent event, Color sides, Color lines,Color sides2,Color lines2, ShapeMode shapeMode, double lineSize) {
            ...
            else NewRenderUtils.thickRender(event,pos,shapeMode,lines,lines2,sides,sides2, lineSize);
            sides.a = preSideA;
            lines.a = preLineA;
            sides2.a = preSideA2;
            lines2.a = preLineA2;
