...
import qwq.wumie.systems.modules.lemon.utils.LEntityUtils;
import qwq.wumie.systems.modules.lemon.utils.LPlayerUtils;

public class BurBreaker extends Module {
    ...
    public BurBreaker() {
        super(Categories.Combat, "bur-breaker", "Automatically mines player's burrow block.");
    }
    ...
    private void onTick(TickEvent.Pre event) {
        ...
        if (LEntityUtils.isBurrowed(target, LEntityUtils.BlastResistantType.Mineable)) {
            blockPosTarget = LEntityUtils.playerPos(target);
        ...
        if (LPlayerUtils.distanceFromEye(blockPosTarget) > mineRange.get()) {
