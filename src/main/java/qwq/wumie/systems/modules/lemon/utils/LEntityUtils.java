...
public class LEntityUtils {
    ...
    public static BlockPos getCityBlock(PlayerEntity player) {
        ...
        posList.sort(Comparator.comparingDouble(LPlayerUtils::distanceFromEye));
    ...
    public static BlockPos playerPos(PlayerEntity targetEntity) {
        return LWorldUtils.roundBlockPos(targetEntity.getPos());
    }
    ...
    public static boolean isBurrowed(PlayerEntity targetEntity, BlastResistantType type) {
        BlockPos playerPos = LWorldUtils.roundBlockPos(new Vec3d(targetEntity.getX(), targetEntity.getY() + 0.4, targetEntity.getZ()));
    ...
    public static boolean isWebbed(PlayerEntity targetEntity) {
        return LWorldUtils.doesBoxTouchBlock(targetEntity.getBoundingBox(), Blocks.COBWEB);
    }
