...
public class PistonAura extends Module {
    ...
    private final Setting<Integer> actionDelay = sgGeneral.add(new IntSetting.Builder().name("action-delay").description("Delay between actions.").defaultValue(120).sliderMin(60).sliderMax(300).build());
    private final Setting<Integer> delayedAttack = sgGeneral.add(new IntSetting.Builder().name("delayed-attack").description("Delayed attack.").defaultValue(25).sliderMin(0).sliderMax(100).build());
