...
public class PacketPlace extends Module {
    ...
    private void place(BlockHitResult result, Hand hand) {
        if (hand != null && result != null) {
            ...
            mc.getSoundManager().play(new PositionedSoundInstance(group.getPlaceSound(), SoundCategory.BLOCKS, (group.getVolume() + 1.0F) / 8.0F, group.getPitch() * 0.5F,soundRandom ,result.getBlockPos()));
