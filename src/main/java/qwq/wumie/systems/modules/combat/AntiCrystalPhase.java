...
import meteordevelopment.meteorclient.events.world.PushOutOfBlockEvent;
...
public class AntiCrystalPhase extends Module {
    ...
    public AntiCrystalPhase() {
        super(Categories.Combat, "anti-crystal-phase", "Allows you to shield the lower half of your hitbox.");
    }
