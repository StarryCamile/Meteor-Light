...
import qwq.wumie.systems.modules.lemon.utils.Interaction;
import qwq.wumie.systems.modules.lemon.utils.RenderInfo;
import qwq.wumie.systems.modules.lemon.utils.RenderMode;

import java.util.ArrayList;
import java.util.Comparator;

import static meteordevelopment.meteorclient.utils.entity.TargetUtils.*;
import static meteordevelopment.meteorclient.utils.player.InvUtils.*;
import static meteordevelopment.meteorclient.utils.player.PlayerUtils.*;
...
import static qwq.wumie.systems.modules.lemon.utils.Interaction.*;
...
public class HolePush extends Module {
    ...
    private final Setting<Boolean> packetPlace = sgGeneral.add(new BoolSetting.Builder().name("packet-place").description("Using packet interaction instead of client.").defaultValue(false).build());
    ...
    private final Setting<Interaction.SwingHand> swing = sgRender.add(new EnumSetting.Builder<Interaction.SwingHand>().name("swing").description("The way to render swing.").defaultValue(SwingHand.Auto).build());
    ...
    public HolePush() {
        super(Categories.Combat, "hole-push", "Push the player in the hole.");
    }
