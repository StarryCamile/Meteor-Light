...
import qwq.wumie.systems.commands.arguments.EnumStringArgumentType;
import meteordevelopment.meteorclient.utils.item.GiveUtils;
...
public class ItemCommand extends Command {
    ...
    public ItemCommand() {
        super("item", "Gives items in creative", "kit");
    }
