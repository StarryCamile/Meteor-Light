...
import qwq.wumie.systems.music.objs.api.EncResObj;
    ...
    public static HttpResObj post(String url, JsonObject data, EncryptType type, String ourl) {
        try {
            ...
            if (MusicManager.cookie.cookieStore.containsKey("music.163.com")) {
                cookies = MusicManager.cookie.cookieStore.get("music.163.com");
            }
            if (type == EncryptType.WEAPI) {
                ...
                res = CryptoUtil.weapiEncrypt(MusicManager.gson.toJson(data));
