package qwq.wumie.systems.music.player.decoder.ogg;

import qwq.wumie.systems.music.MusicManager;
import qwq.wumie.systems.music.player.APlayer;
import qwq.wumie.systems.music.player.decoder.BuffPack;
import qwq.wumie.systems.music.player.decoder.IDecoder;
import qwq.wumie.systems.music.player.decoder.ogg.jcraft.jogg.Packet;
import qwq.wumie.systems.music.player.decoder.ogg.jcraft.jogg.Page;
import qwq.wumie.systems.music.player.decoder.ogg.jcraft.jogg.StreamState;
import qwq.wumie.systems.music.player.decoder.ogg.jcraft.jogg.SyncState;
import qwq.wumie.systems.music.player.decoder.ogg.jcraft.jorbis.Block;
import qwq.wumie.systems.music.player.decoder.ogg.jcraft.jorbis.Comment;
import qwq.wumie.systems.music.player.decoder.ogg.jcraft.jorbis.DspState;
import qwq.wumie.systems.music.player.decoder.ogg.jcraft.jorbis.Info;
import qwq.wumie.systems.music.player.decoder.ogg.jcraft.oggdecoder.OggData;
...
public class OggDecoder implements IDecoder {
    ...
    public boolean set() throws Exception {
        new Thread(() -> {
            ...
            get1.release();
        }, "MusicManager.INSTANCEmusic_ogg").start();
        get1.acquire();
        return isOK;
    }
