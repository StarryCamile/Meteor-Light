...
public class MineplexTpAuraNodeProcessor extends NodeProcessor {
	...
	public Node createNode(BlockPos pos) {
		return new Node(!isStairBlock(Utils.getBlock(pos.down())) && isPassable(Utils.getBlockState(pos),pos) && isPassable(Utils.getBlockState(pos.up()),pos), pos).setId(pos.hashCode());
	}
