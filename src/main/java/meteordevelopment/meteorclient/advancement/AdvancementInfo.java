/*package meteordevelopment.meteorclient.advancement;
...
import qwq.wumie.systems.modules.render.BetterAdvancement;
...
public class AdvancementInfo {
    ...
    static {
       // active = Modules.get().get(BetterAdvancement.class).isActive();
    }
