...
public class Mesh {
    ...
    public long getVerticesPointer() {
        return verticesPointer;
    }

    public void setVerticesPointer(long verticesPointer) {
        this.verticesPointer = verticesPointer;
    }
    ...
    public void setIndicesPointer(long indicesPointer) {
        this.indicesPointer = indicesPointer;
    }
    ...
    public void beginRender(MatrixStack matrices) {
        ...
        if (rendering3D) {
            ...
            if (Config.get().fixPosTranslate.get() && mc.world != null) {
