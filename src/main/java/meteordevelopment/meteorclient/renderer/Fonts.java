...
public class Fonts {
    public static final String[] BUILTIN_FONTS = { "JetBrains Mono", "Comfortaa", "Tw Cen MT", "Pixelation", "GoogleSans", "SFUI", "JelloLight","JelloMedium","JelloRegular","Jello", "AldotheApache", "DreamScape", "DamagrafikScript"};
