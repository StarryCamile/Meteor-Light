...
public class Config extends System<Config> {
    ...
    public final Setting<Boolean> toggleSound = sgOther.add(new BoolSetting.Builder()
            .name("toggle-sound")
            .description("toggle module play sound")
            .defaultValue(true)
            .build()
    );
    public final Setting<Boolean> disableGLDEBUG = sgOther.add(new BoolSetting.Builder()
            .name("disable-gl-debug")
            .defaultValue(true)
            .build()
    );
    public final Setting<Boolean> fixPosTranslate = sgOther.add(new BoolSetting.Builder()
            .name("fix-2d-pos-translate")
            .defaultValue(false)
            .build()
    );
