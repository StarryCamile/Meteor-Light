...
public class Blur extends Module {
    ...
    public final IntDoubleImmutablePair[] strengths = new IntDoubleImmutablePair[]{
    ...
    // General
    public final Setting<Integer> strength = sgGeneral.add(new IntSetting.Builder()
            .name("strength")
    ...
    public final Setting<Integer> fadeTime = sgGeneral.add(new IntSetting.Builder()
            .name("fade-time")
