...
import qwq.wumie.version.meteor051.HudRendererPlus;
...
public class HudRenderer extends HudRendererPlus {
    ...
    public double delta;
    public LGuiRender parent;

    public HudRenderer(LGuiRender parent) {
        this.parent = parent;
    }

    public HudRenderer() {
        this.parent = new LGuiRender();
    ...
    public double text(String text, double x, double y, Color color) {
        return text(text, x, y, color, false, -1);
    }
