...
import qwq.wumie.version.meteor051.MeteorClientPlus;

import java.io.File;
import java.lang.invoke.MethodHandles;

public class MeteorClient extends MeteorClientPlus implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        // Register addons
        AddonManager.init();
        new MainHandler().preLoad();

        // Register event handlers
        EVENT_BUS.registerLambdaFactory(MainHandler.ADDON.getPackage() ,(lookupInMethod, klass) -> (MethodHandles.Lookup) lookupInMethod.invoke(null, klass, MethodHandles.lookup()));
